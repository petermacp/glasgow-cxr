...
m_pulmonary_division <- brm(
  cases ~ y_num + acf_period + acf_period:y_num + (1 | division) + offset(log(population_without_inst_ship)),
                  data = mdata3,
                  family = poisson(),
                  seed = 1234,
                  chains = 4, cores = 4, 
...
plot_counterfactual(model=m_pulmonary_division, model_data=mdata3, population_denominator = population_without_inst_ship, outcome = cases, grouping_var = division, division)
