...
overall_change_extrapulmonary <- summarise_change(model_data=overall_scaffold %>% filter(year<=1961), model=m_extrapulmonary, 
                                   population_denominator=population_without_inst_ship, grouping_var=NULL, re_formula = NA)
...
overall_ep_counterf <- calculate_counterfactual(model_data=overall_scaffold %>% filter(year<=1961), model=m_extrapulmonary, 
                                               population_denominator = population_without_inst_ship)
